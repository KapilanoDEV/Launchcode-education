...
public class HelloController {
    ...
    //Handles http://localhost:8080/hello/formFriend
    // form requests that route to the helloNameQueryParam above
    ...
    //Handles  http://localhost:8080/hello/formLang
    // form requests that route to the hiWorld above
    //When the form method is get I see context hello/hiWorld?firstName=Minerva
    //..in the address bar. If it is POST then hello/hiWorld only
    @GetMapping("formLang")
